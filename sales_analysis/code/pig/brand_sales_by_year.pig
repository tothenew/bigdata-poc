...
price_brand = foreach filtered generate year as year, brand_name as brand_name, (item_purchased*price) as totalPrice;

group_by_brand = Group price_brand by (year, brand_name);

finalResult = foreach group_by_brand generate group, SUM(price_brand.totalPrice) as totalPrice;
