...
group_by_brand = Group price_brand by (year,month, brand_name);

finalResult = foreach group_by_brand generate FLATTEN(group) as (year,month, brand_name), SUM(price_brand.totalPrice) as totalPrice;
